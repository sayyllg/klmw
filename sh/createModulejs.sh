...
* author: XXXXXX
*/
Ehr.module('$2', function($3, Ehr, Backbone, Marionette, $, _){
...
* author: XXXXXX
*/
Ehr.module('$3.Router', function(Router, Ehr, Backbone, Marionette, $, _){
...
* author: XXXXXX
*/
Ehr.module('$3.Dicts', function(Dicts, Ehr, Backbone, Marionette, $, _) {
...
* author: XXXXXX
*/
Ehr.module('$3.Entities', function(Entities, Ehr, Backbone, Marionette, $, _){
...
* author: XXXXXX
*/
Ehr.module('$3.Views',function(Views, Ehr, Backbone, Marionette, $, _){
...
* author: XXXXXX
*/
Ehr.module('$3.Templates', function(Templates, Ehr, Backbone, Marionette, $, _){
